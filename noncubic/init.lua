...
minetest.log("action", "[MOD] [\"noncubic\"] Use of depriciated function \"noncubic.register_slope_lying\" ")
end
...
function noncubic.register_slope_upsdown(subname, recipeitem, groups, images, description)
	minetest.log("action", "[MOD] [\"noncubic\"] Use of depriciated function \"noncubic.register_slope_upsdown\" ")
end
...
minetest.register_node("noncubic:slope_inner_edge_" .. subname, {
	description = description,
	drawtype = "mesh",
	mesh = "noncubic_slope_inner_edge.obj",
	tiles = images,
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = true,
...
minetest.log("action", "[MOD] [\"noncubic\"] Use of depriciated function \"noncubic.register_slope_upsdown_edge\" ")
end
...
minetest.log("action", "[MOD] [\"noncubic\"] Use of depriciated function \"noncubic.register_slope_upsdown_inner_edge\" ")end
...
minetest.log("action", "[MOD] [\"noncubic\"] Use of depriciated function \"noncubic.register_cylinder_horizontal\" ")
end
...
local detail = detail_level
local sehne,sehne2
for xz = 0, detail-1 do
	for y = 0, detail-1 do
		sehne = math.sqrt(0.25 - (((xz/detail)-0.5)^2))
		sehne2 = (math.sqrt(0.25 - (((y/detail)-0.5)^2)))*2
		local table_pos = y + (detail * (xz - 1))
		spherebox[table_pos]={ ((xz/detail)-0.5)*sehne2, ((1/detail)*y)-(1/detail)-.5, -(sehne)*sehne2,  ((xz/detail)+(1/detail)-0.5)*sehne2,(((1/detail)*y)+(1/detail))-(1/detail)-.5, (sehne)*sehne2}
-- for epic shape try this>>> spherebox[table_pos]={-sehne-((sehne/sehne2)), (xz/detail)-0.5, -sehne-((sehne/sehne2)), sehne-((sehne/sehne2)), (xz/detail)+(1/detail)-0.5, sehne-((sehne/sehne2))}
	end
end
